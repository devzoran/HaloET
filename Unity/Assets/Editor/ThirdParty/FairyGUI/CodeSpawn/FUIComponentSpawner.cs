...
namespace FUIEditor
{
    ...
    {
        private static readonly List<string> ControllerNames = new();
        private static readonly List<string> TransitionNames = new();
        private static readonly Dictionary<string, List<string>> ControllerPageNames = new();
        ...
        {
            if (componentType is ComponentType.Button or ComponentType.ComboBox)
            {

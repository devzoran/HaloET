...
namespace ET
{
    ...
    public static class FGUIHelper
    {
        ...
        {
            await FGUIComponent.Instance.GetComponent<MessageWait>().Wait(id.ToString());
        }
        public static async ETTask WaitShowen(string PanelId)
        {
            await FGUIComponent.Instance.GetComponent<MessageWait>().Wait(PanelId);
        }
        ...
        {
            FGUIComponent.Instance.ShowPanelAsync(id, showData, prePanelId).Coroutine();
        }

        public static void ShowPanel<T>(Entity showData = null, PanelId prePanelId = PanelId.Invalid) where T : Entity
        {
            FGUIComponent fuiComponent = FGUIComponent.Instance;
            ...
            if (showData != null)
            {
                ShowPanelData paneldata = ObjectPool.Instance.Fetch<ShowPanelData>();
        ...
        {
            FGUIComponent.Instance.ClosePanel(id);
        }
        ...
        {
            FGUIComponent.Instance.ClosePanelByType(targetPanelType, ignorePanelId);
        }
        
        public static void CloseAllPanel()
        {
            FGUIComponent.Instance.CloseAllPanel();
        }
        ...
        public static void ShowPanelByName(string panelName, ShowPanelData data = null)
        {
            ...
            FGUIComponent.Instance.ShowPanel(panelId, data);
        }
        ...
        public static void ClosePopUpPanels()
        {
            ...
            //刷新界面
            PanelId panelId = fuiComponent.GetLastPanel();
            if (panelId == PanelId.Invalid)
            {
                return;
            }

            FGUIEntity fuiEntity = fuiComponent.GetFUIEntity(panelId);
            fuiEntity.GComponent.visible = true;
            FGUIEventComponent.Instance.GetUIEventHandler(panelId).OnShow(fuiEntity);
        }
        ...
        {
            return FGUIComponent.Instance.IsPanelVisible(panelId);
        }
        ...
        {
            return FGUIComponent.Instance.GetPanel<T>();
        }

        public static FGUIEntity GetFUIEntity(string panelId)
        {
            return FGUIComponent.Instance.GetFUIEntity(panelId);
        }
